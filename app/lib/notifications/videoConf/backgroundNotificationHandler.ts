// Removed: notifee, firebase messaging
import AsyncStorage from '@react-native-async-storage/async-storage';
import ejson from 'ejson';

import { deepLinkingClickCallPush } from '../../../actions/deepLinking';
import i18n from '../../../i18n';
// import { colors } from '../../constants'; // no longer needed without notifee
import { store } from '../../store/auxStore';

// Comment or remove if unused elsewhere
...
// Stubbed for future use or debugging
const backgroundNotificationHandler = () => {
	// You can implement an alternative native module handler here.
};

const setBackgroundNotificationHandler = () => {
	// Push handling removed. You can integrate a custom notification system if needed.
};
